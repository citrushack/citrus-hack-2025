...
const Questions = ({
  ...
  return (
    <div className="flex w-full flex-col gap-5">
      ...
      <div className="font-kumar text-white">
        <p className="mt-3 font-semibold">Resources</p>
        <Link
          href="https://static.mlh.io/docs/mlh-code-of-conduct.pdf"
          target="_blank"
          className="items-cente mt-1 flex no-underline hover:text-opacity-65"
        >
          MLH Code of Conduct
        ...
        <Link
          ...
          target="_blank"
          className="mt-3 flex items-center no-underline hover:text-opacity-65"
        >
          MLH Privacy Policy
          <SquareArrowOutUpRight className="mx-2" size={15} />
        </Link>
