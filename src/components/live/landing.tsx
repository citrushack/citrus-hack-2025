...
import LandingBottom from "./landing-assets";

const Landing = () => {
  return (
    <div className="flex w-full flex-col items-center justify-center py-20 md:py-[5%]">
      <div className="relative flex w-3/4 flex-col items-center gap-4 rounded-2xl border-8 border-black bg-citrus-beige px-5 py-10 md:border-[15px] md:py-14">
